...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   KC_LGUI, MO(_FN1),         MO(_FN2),KC_LSFT, KC_SPC,      KC_ENT,  KC_RSFT, MO(_FN1),         MO(_FN2),KC_RGUI,
                                                _______
   ),

   [_FN1] = LAYOUT(
   KC_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_ZKHK,     KC_1,    KC_2,    KC_3,    KC_0,    KC_MINS, KC_EQL,
   KC_F12,  KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_TILD,     KC_4,    KC_5,    KC_6,    _______, KC_BSLS, KC_RBRC,
   _______, KC_F9,   KC_F10,  _______, _______, _______,     KC_7,    KC_8,    KC_9,    _______, _______, _______,
